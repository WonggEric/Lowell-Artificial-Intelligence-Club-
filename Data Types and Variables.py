...
#Should always use variables when a value is constantly changing
...
#Concatenation: Combining strings, numbers, and variables, 2 ways
my_name = 'Eric'
highschool  = 'Lowell'

#Option 1:
print('Hello my name is ' + my_name + ', I am 16' + ' and I got to ' + highschool) 
# Hello my name is Eric, I am 16 and I go to Lowell
